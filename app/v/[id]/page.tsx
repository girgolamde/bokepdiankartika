...
export default async function Video({ params }: PageProps) {
    ...
    const file = data.result[0];
        ...
        url: `https://bokepdiankartika.pages.dev/v/${file.filecode}`,
    ...
    return (
        ...
        {/* ... */}
            ...
            <Card className="mx-2 mb-8">
                ...
                </CardHeader><ins id="1078976" data-width="300" data-height="112"></ins>
            ...
            </h2><ins id="1078976" data-width="300" data-height="112"></ins>
